...
#' @param type A character vector of \code{'null'} or \code{'rejection'} indicating whether the function should return the null region or rejection region, respectively, related to \code{statistic.sim.obj}.
#' 
#' @return Returns a numeric vector with the set of pixels comprising the null or rejection region related to \code{statistic.sim}.
